...
CREATE TABLE `voucher_redemption` (
  ...
  KEY `voucher_redemption_ibfk_2_idx` (`customer_id`),
  CONSTRAINT `voucher_redemption_ibfk_1` FOREIGN KEY (`voucher_id`) REFERENCES `voucher` (`voucher_id`),
  CONSTRAINT `voucher_redemption_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`),
  CONSTRAINT `voucher_redemption_ibfk_3` FOREIGN KEY (`booking_id`) REFERENCES `booking` (`booking_id`)
...
-- Dump completed on 2026-06-16 23:28:00
